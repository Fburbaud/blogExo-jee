...
public class Article {
	...
	public Article(String titre, String resume, String contenu, User user) {
		super();
		this.titre = titre;
		this.resume = resume;
		this.contenu = contenu;
	...
	public Article(String titre, String resume, String contenu, Date date_creation, User user) {
		super();
		this.titre = titre;
		this.resume = resume;
		this.contenu = contenu;
